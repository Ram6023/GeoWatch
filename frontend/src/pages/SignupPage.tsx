...
import { Eye, EyeOff, Globe2, Mail, Lock, User, ArrowRight, Sparkles, CheckCircle2 } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const features = [
    'Real-time satellite imagery monitoring',
    'AI-powered change detection',
    'NDVI trend analysis & charts',
      ...
      <div className="hidden lg:flex lg:w-1/2 hero-gradient relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-12 text-white">
          ...
          <p className="text-xl text-blue-200 mb-8 flex items-center gap-2">
            ...
            Start monitoring the Earth today
          </p>

          {/* Features List */}
          <div className="max-w-md w-full">
            <h3 className="text-lg font-semibold mb-4 text-blue-200">What you'll get:</h3>
            <ul className="space-y-3">
              {features.map((feature, index) => (
                <li key={index} className="flex items-center gap-3 text-white/90">
                  <CheckCircle2 className="h-5 w-5 text-geowatch-accent flex-shrink-0" />
                  <span>{feature}</span>
                </li>
              ))}
            </ul>
          ...
          {/* Trust Badge */}
          <div className="mt-12 px-6 py-3 bg-white/10 backdrop-blur rounded-2xl border border-white/20">
            <p className="text-sm text-blue-200">
              Powered by <span className="font-semibold text-white">Google Earth Engine</span>
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-slate-600 dark:text-slate-400">
              Start monitoring with GeoWatch in minutes
            </p>
          </div>
